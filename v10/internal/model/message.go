...
type Danmaku struct {
	...
	MessageID string    `gorm:"type:varchar(64);not null;uniqueIndex:uk_v10_message_id;index:idx_v10_room_cursor,priority:3" json:"message_id"`
	RoomID    string    `gorm:"type:varchar(64);not null;index:idx_v10_room_cursor,priority:1" json:"room_id"`
