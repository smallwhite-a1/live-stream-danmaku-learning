...
const (
	DefaultRedisAddr   = "127.0.0.1:6384"
	KeyRoomPubSub      = "v10:room:%s:pubsub"
	KeyRoomLikes       = "v10:room:%s:likes"
	KeyRoomServerCount = "v10:room:%s:online:%s"
	KeyRoomServers     = "v10:room:%s:servers"
