...
import (
	...
	"github.com/charlesAcmen/livestream-danmaku/v10/internal/consumer"
...
func main() {
	...
	topic := flag.String("topic", getenv("V10_KAFKA_TOPIC", infra.DefaultKafkaTopic), "Kafka topic")
	dlqTopic := flag.String("dlq-topic", getenv("V10_KAFKA_DLQ_TOPIC", infra.DefaultKafkaDLQTopic), "Kafka dead letter topic")
	groupID := flag.String("group", getenv("V10_KAFKA_GROUP", infra.DefaultKafkaGroupID), "Kafka consumer group id")
