...
const (
	DefaultRedisAddr   = "127.0.0.1:6381"
	KeyRoomPubSub      = "v7:room:%s:pubsub"
	KeyRoomLikes       = "v7:room:%s:likes"
	KeyRoomServerCount = "v7:room:%s:online:%s"
	KeyRoomServers     = "v7:room:%s:servers"
