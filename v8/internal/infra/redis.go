...
const (
	DefaultRedisAddr   = "127.0.0.1:6382"
	KeyRoomPubSub      = "v8:room:%s:pubsub"
	KeyRoomLikes       = "v8:room:%s:likes"
	KeyRoomServerCount = "v8:room:%s:online:%s"
	KeyRoomServers     = "v8:room:%s:servers"
