...
const (
	DefaultKafkaBrokers  = "127.0.0.1:9097"
	DefaultKafkaTopic    = "v8_danmaku_save_topic"
	DefaultKafkaGroupID  = "v8_danmaku_save_group"
	DefaultKafkaDLQTopic = "v8_danmaku_save_dlq"
)
